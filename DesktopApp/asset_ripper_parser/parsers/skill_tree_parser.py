...
def replace_placeholders_in_description(skill_component: dict, description: str) -> str:
    ...
    try:
        ...
        logging.error(
            "Unable to populate description placeholders for %s",
            description,
            exc_info=True,
        )
        return description
...
def parse_skill_trees(
    ...
    Args:
        ...
        report_progress (function, optional): Called after each item has been parsed.
                                              Defaults to None.
    ...
    for path in filepaths:
        ...
        try:
            ...
            try:
                ...
                skills = parse_skills(indexer, referenced_skills)
