...
from DesktopApp.asset_ripper_parser.parsers.furniture_parser import Furniture
...
def parse_wallpaper(
    ...
    for path in items:
        ...
        try:
            ...
            sprite_path = indexer.find_sprite_path_from_guid(
                item_component["wallpaper"]["guid"]
            )
